                            ...
                            DrawMode::Rotate => {
                                match program_state {
                                    ...
                                    Some(Pending::Rotate { 
                                        ...
                                        let mut step_count = *step_count + delta;
                                        let theta = 0.05*delta;

                                        let degrees = if step_count * theta.acos() > 180.0 {
                                            step_count = 0.0;
                                            step_count * theta.acos()
                                        } else if step_count * theta.acos() < 0.0 {
                                            180.0 - (step_count * theta.acos())
                                        } else {
                                            step_count * theta.acos()
                                        };
